# DispatchTalon Proof Ops Pack

Status: Internal proof-building system
Purpose: Turn active pilot use into claim-safe commercial evidence
...
| `DISPATCHTALON_ADVISOR_FEEDBACK_TRACKER_TEMPLATE.csv` | Tracker template for advisor feedback by lens and risk category. |
| `DISPATCHTALON_CLAIM_SAFE_LANGUAGE_RULES_v1.md` | Internal guardrail for approved, restricted, and forbidden language. |
| `DISPATCHTALON_30_DAY_PILOT_PROOF_PLAN.md` | Operating plan for turning pilot access into commercial evidence. |
...
- Use the 30-day plan to decide whether a lead should continue, convert, narrow, or stop.
...
- raw tracker files containing private pilot notes
- internal competitor notes without source verification
- investor/grant brief as if it proves eligibility
- any file containing advisor private details
- screenshots or records containing real pilot data
- passwords, tokens, stored upload keys, or private source documents

## Update Cadence

Update weekly during active pilot review.

Minimum update triggers:

- new pilot user activated
- advisor feedback received
- claim boundary changed
- competitor source verification completed
- paid pilot interest appears
- product capability changes
- a feature is removed, delayed, or reframed

This pack should create cleaner proof, not more noise.
